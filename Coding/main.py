...
app = Flask("Course Catalog")  #naming our application
app.secret_key = "ChaseIsCool"  #it is necessary to set a password when dealing with OAuth 2.0
os.environ["OAUTHLIB_INSECURE_TRANSPORT"] = "1"  #this is to set our environment to https because OAuth 2.0 only supports https environments

GOOGLE_CLIENT_ID = "94961696527-0mredua6m4k9p8te5ltf9o734qa4gs8p.apps.googleusercontent.com"  #enter your client id you got from Google console
